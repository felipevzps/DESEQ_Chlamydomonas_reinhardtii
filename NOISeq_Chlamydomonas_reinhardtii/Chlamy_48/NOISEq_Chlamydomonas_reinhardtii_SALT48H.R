...
#setwd("/home/felipe/Documents/DESEQ_Chlamydomonas_reinhardtii/NOISeq_Chlamydomonas_reinhardtii/Chlamy_48")
#PC CENA
setwd("/home/felipevzps/Documentos/DESEQ_Chlamydomonas_reinhardtii/NOISeq_Chlamydomonas_reinhardtii/")

experimentalMatrix<-read.csv("Chlamy_48/target_without_LOM1.24.1_LOM1.24.2_LOM2.24.1_LOM2.24.3_SALT48H.csv",header=TRUE)
...
"1625 differentially expressed features"
...
DE.plot(mynoiseqTech, q = 0.8, graphic = "MD", log.scale = TRUE, title(main = "differential expression (48h)", xlab = "log-fold change", ylab = "absolute value of the difference in expression between conditions"))
...
# 18414 differentially expressed features

#export results to archive or for downstream analyses (complete gene list)
write.csv(mynoiseqTech.deg.allGenes, file="DEGs_NOISeqTech_SALT48H_allGenes.csv")
