# topGO Chlamydomonas reinhardtii 24h vs 48h 
...
write.table(topGO_all_table, file = paste0("topGO_Chlamydomonas_reinhardtii_24_48", ".BP", ".csv"), sep =",", quote= F, col.names = T)
