# topGO Chlamydomonas reinhardtii 24h vs 48h (enrichment of TFs)
...
# Notebook
setwd("/home/felipe/Documents/DESEQ_Chlamydomonas_reinhardtii/GO_enrichment/NOISeq_24_48/TF_enrichment")

# CENA
#setwd("/home/felipevzps/Documentos/DESEQ_Chlamydomonas_reinhardtii/GO_enrichment/NOISeq_24h")

dados <- read.table("DEGs_NOISeq_CRE_v5.6.hmmsearch_PlnTFDVPfam32.families.24_48_scores.txt", header = FALSE, sep = ",")
dados
...
write.table(topGO_all_table, file = paste0("topGO_TFs_Chlamydomonas_reinhardtii_24h_48h", ".BP", ".csv"), sep =",", quote= F, col.names = T)
...
write.table(formatted_lines, file = paste0("topGO_TFs_Chlamydomonas_reinhardtii_24h_48h_ann.genes.BP.csv"), quote= F, col.names = F, row.names = F, sep="\n")
