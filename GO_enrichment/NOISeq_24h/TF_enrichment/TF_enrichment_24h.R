...
# Notebook
setwd("/home/felipe/Documents/DESEQ_Chlamydomonas_reinhardtii/GO_enrichment/NOISeq_24h/TF_enrichment")

# CENA
#setwd("/home/felipevzps/Documentos/DESEQ_Chlamydomonas_reinhardtii/GO_enrichment/NOISeq_24h")

dados <- read.table("DEGs_NOISeq_CRE_v5.6.hmmsearch_PlnTFDVPfam32.families.24H_scores.txt", header = FALSE, sep = ",")
dados
